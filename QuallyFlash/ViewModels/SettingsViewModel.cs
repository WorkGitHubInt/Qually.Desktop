...
namespace QuallyFlash
{
    public class SettingsViewModel : BaseViewModel
    {
        ...
        private void LoadFromFile()
        {
            ...
            {
                MessageBox.Show("Произошла ошибка при загрузке настроек из файла! Убедитесь, что файл был создан текущей версией программы! Ошибка: " + e.Message, "", MessageBoxButton.OK, MessageBoxImage.Warning);
            }
        }
        ...
        private void SaveToFile()
        {
            ...
            {
                MessageBox.Show("Произошла ошибка при сохранении настроек в файла! Ошибка: " + e.Message, "", MessageBoxButton.OK, MessageBoxImage.Warning);
            }
        }
        ...
        private void Accept()
        {
            ...
            {
                MessageBox.Show("Был выставлен резервный КСК, но не выбран свой или не введен ID! Выставьте правильно настройки и повторите!", "", MessageBoxButton.OK, MessageBoxImage.Warning);
            }
            else
            {
